...
public class MCGServer {
	...
	public MCGServer(){	
		try {
			...
			System.out.println("initialize mcg server");
		}
		catch(SocketException e) {
			System.out.println("initialize mcg server error ..........");
			}
	}
	...
	public void start() {
		...
		try {
			logService log = new logService("MCGserver");		
			LibraryObj obj = new LibraryObj();
			obj = new LibraryObj("MCGserver");	

			System.out.println("MCG Server ready and waiting ...");
			...
			try {
				...
				//System.out.println("Port 2222 ready............");
				...
				System.out.println("Socket MCG: " + e.getMessage());
			} catch (IOException e) {
