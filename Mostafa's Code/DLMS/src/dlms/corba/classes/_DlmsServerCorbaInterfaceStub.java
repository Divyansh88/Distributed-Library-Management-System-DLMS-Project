...
/**
* classes/_DlmsServerCorbaInterfaceStub.java .
...
public class _DlmsServerCorbaInterfaceStub extends org.omg.CORBA.portable.ObjectImpl implements comp.dsd.dlms.corba.classes.DlmsServerCorbaInterface
{
  ...
  public String joinToItemWaitList (String userID, String itemID, int numberOfDays)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("joinToItemWaitList", true);
                $out.write_string (userID);
                $out.write_string (itemID);
                $out.write_long (numberOfDays);
                $in = _invoke ($out);
                ...
                return joinToItemWaitList (userID, itemID, numberOfDays        );
            } finally {
                _releaseReply ($in);
            }
  } // joinToItemWaitList
  ...
  public String leaveItemWaitList (String userID, String itemID)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("leaveItemWaitList", true);
                $out.write_string (userID);
                $out.write_string (itemID);
                $in = _invoke ($out);
                String $result = $in.read_string ();
                ...
                return leaveItemWaitList (userID, itemID        );
            } finally {
                _releaseReply ($in);
            }
  } // leaveItemWaitList
...
} // class _DlmsServerCorbaInterfaceStub
